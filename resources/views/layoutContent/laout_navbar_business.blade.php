...
<link href="{{asset('frontend/css/navbar_layout.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <div id="nav">
    <div class="container clearfix layout_navbar_css">
        <ul id="jetmenu" class="jetmenu blue">
            <li class="active"  ><a style="padding-right: 55Px;" href="/">Home</a></li>
            ...
            <li><a href="#" style="padding-right: 45Px;">Business Units</a>
                <ul class="dropdown">
                    <!--                                    <li><a > </a>-->
