...
<div id="nav">
<div class="container clearfix layout_navbar_css" style=" margin-left: -2.6%;margin-top: 1px;">
    <ul id="jetmenu" class="jetmenu blue">
        <li class="active"  ><a style="padding-right: 30Px;" href="/">Home</a></li>
        ...
        <li><a href="#" style="padding-right: 30Px;">Business Units</a>
            <ul class="dropdown">
                <!--                                    <li><a > </a>-->
                <li><a style="padding-right: 55px;"> Current Projects</a>
                        ...
                        <li ><a href="/rppl" ><span>Reedisha Food Limited</span></a></li>
                        <li ><a href="/rppl" ><span>Reedisha Blended Yarn Limited</span></a></li>

                
                    </ul>
                </li>

                <li><a style="padding-right: 30Px;"> Upcoming Projects</a>
                    <ul class="dropdown">
        ...
        <li><a href=""style="padding-right: 30Px;">Certificates</a>
            <ul class="dropdown">
        ...
        <li><a href="#"style="padding-right: 30Px;">Photo Gallery</a>
            <ul class="dropdown">
        ...
        <li><a href="#"style="padding-right: 30Px;">Career</a>
            <ul class="dropdown">
        ...
        <li><a href="/contact"style="padding-right: 55Px;">Contact Us</a></li>
